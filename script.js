...
document.addEventListener("DOMContentLoaded", function () {
    const APIKEY = "67a8993a99fb601085e983c4";
    ...
    if (contactSubmit) {
        contactSubmit.addEventListener("click", async function (e) {
            ...
            async function checkExistingRecords() {
                ...
                const response = await fetch(`https://mokeselldb11-beb9.restdb.io/rest/accounts?q=${encodeURIComponent(filter)}`, settings);
    ...
    if (loginForm) {
        loginForm.addEventListener("submit", async function (event) {
            ...
            try {
                ...
                const response = await fetch(`https://mokeselldb11-beb9.restdb.io/rest/accounts?q=${encodeURIComponent(filter)}`, {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
                        "x-apikey": APIKEY,
    ...
    if (userEmail) {
        const url = `https://mokeselldb11-beb9.restdb.io/rest/accounts?q={"email":"${userEmail}"}`;
    ...
    //listings
    const RESTDB_COLLECTION_URL = "https://mokeselldb11-beb9.restdb.io/rest/listings";
    ...
    async function fetchListings() {
        try {
            let response = await fetch("https://mokeselldb11-beb9.restdb.io/rest/listings", {
                method: "GET",
                headers: { "x-apikey": APIKEY, "Content-Type": "application/json" }
            });
    ...
    async function displayListings(listings) {
        ...
        for (const listing of listings) {
            try {
                ...
                const userResponse = await fetch(`https://mokeselldb11-beb9.restdb.io/rest/accounts?q=${emailQuery}`, {
                    method: "GET",
                    headers: { 
                        "x-apikey": APIKEY, 
                        "Content-Type": "application/json" 
    ...
    async function fetchListingDetails() {
        try {
            const response = await fetch(`https://mokeselldb11-beb9.restdb.io/rest/listings/${listingId}`, {
                method: "GET",
    ...
    async function fetchFilteredListings(category = null) {
        try {
            let url = 'https://mokeselldb11-beb9.restdb.io/rest/listings';
    ...
    async function searchListings() {
        ...
        try {
            ...
            const response = await fetch("https://mokeselldb11-beb9.restdb.io/rest/listings", {
                method: "GET",
                headers: { "x-apikey": APIKEY }
            });
        ...
        async function fetchUserListings() {
            try {
                const response = await fetch(`https://mokeselldb11-beb9.restdb.io/rest/listings?q={"sellerEmail":"${sellerEmail}"}`, {
                    method: "GET",
                    headers: {
                        "x-apikey": "67a8993a99fb601085e983c4",
                        "Content-Type": "application/json"
                    }
                });
    ...
    async function fetchMyListings() {
        try {
            const response = await fetch(`https://mokeselldb11-beb9.restdb.io/rest/listings?q={"sellerEmail":"${userEmail}"}`, {
                method: "GET",
                headers: {
                    "x-apikey": APIKEY,
                    "Content-Type": "application/json"
